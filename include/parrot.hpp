// These frames are directly ripped from parrot.live (https://github.com/hugomd/parrot.live) credits to them 🐦🔥🔥

#pragma once

#include <string>

const std::wstring frames[] = {
    LR"(
                         .cccc;;cc;';c.           
                      .,:dkdc:;;:c:,:d:.          
                     .loc'.,cc::c:::,..;:.        
...
std::wstring get_frame(int frame_count) {
    int ranged_frame_count = frame_count % 10;
    return frames[ranged_frame_count];
}
